...
public class MyScanCheck implements ScanCheck {
    ...
    public AuditResult passiveAudit(HttpRequestResponse httpRequestResponse) {
        try {
            Pair<GPTRequest, diyGPTResponse> gptResults = gptClient.identifyVulnerabilities(httpRequestResponse);
    ...
    private List<AuditIssue> createAuditIssuesFromGPTResponse(Pair<GPTRequest, diyGPTResponse> gptResults,
                                                              HttpRequestResponse httpRequestResponse) {
        List<AuditIssue> auditIssues = new ArrayList<>();
        GPTRequest gptRequest = gptResults.getLeft();
        diyGPTResponse gptResponse = gptResults.getRight();
